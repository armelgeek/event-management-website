...
const AppClientMenu = () => {
  ...
  return (
    <nav
      className="w-full sticky top-0  z-40 bg-white/80 backdrop-blur border-b border-gray-100 shadow-sm px-4 sm:px-6 lg:px-8 xl:px-52 h-16 flex items-center"
    ...
    >
      ...
      {/* Nav center */}
      <div className="hidden md:flex flex-1 ml-5 justify-start items-center gap-1">
